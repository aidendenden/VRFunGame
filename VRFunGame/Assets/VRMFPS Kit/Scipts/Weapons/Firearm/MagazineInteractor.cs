...
namespace VRMultiplayerFPSKit
{
    ...
    public class MagazineInteractor : XRSocketInteractor
    {
        ...
        public void DetachMagazine()
        {
            ...
            //Force detach magazine on server too, since authority now is transferred to the server
            XRMultiplayerInteractor.localInstance.CMD_ForceDetachInteractable(interactablesSelected[0].transform.GetComponent<NetworkIdentity>());
            //Detach interactable
        ...
        protected override void OnSelectEntered(SelectEnterEventArgs args)
        {
            ...
            //If we have authority, update the current magazine in weapon script
            if (_identity.isOwned)
        ...
        private bool MagazineCompatibleFilter(IXRSelectInteractor interactor, IXRSelectInteractable interactable)
        {
            ...
            if (!magazine)
                return false;
            if (!magazine.IsCompatibleWithWeapon(_firearm))
                return false;
        ...
        protected override void Awake()
        {
            ...
            if (_identity == null || _firearm == null)
